# -*- coding: utf-8 -*-
# Generated by Django 1.11.17 on 2019-03-20 18:11
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('opening_hours', models.CharField(default='', max_length=256)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('plant_slug', models.CharField(default=' ', max_length=128)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('id', models.AutoField(auto_created=True, primary_key=True, serialize=False, verbose_name='ID')),
                ('picture', models.ImageField(blank=True, null=True, upload_to='media/user_profile_images')),
